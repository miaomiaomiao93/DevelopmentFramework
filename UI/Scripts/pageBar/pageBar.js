        ...
        //if (page_new != self.page_now) {
            ...
            if (self.page_max > 0) {
                ...
                if (self.page_max == 1) {
                    ...
                    // 将页码，首页，尾页，跳转页码组装起来
                    new_page_inner =/* '<a href="javascript:;" data="1" >首页</a>' +*/ new_page_inner /*  '<a href="javascript:;" data="' + self.page_max + '">尾页</a>*/ + '<a href="javascript:;" data="01" class="pageUpDown">上一页</a>' + '<a href="javascript:;" data="02" class="pageUpDown">下一页</a>';
                }
